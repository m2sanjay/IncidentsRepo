            ...
            <Block style={styles.registerContainer}>
              <Block flex={0.25} middle style={styles.socialConnect}>
                ...
                <Block row style={{ marginTop: theme.SIZES.BASE, marginLeft: 25 }}>
                  <Button style={{...styles.socialButtons, marginRight: 30, backgroundColor: theme.COLORS.FACEBOOK }} onPress={() => navigation.navigate("Home")}>
                    <Block row>
                      <Icon
                        name="logo-facebook"
                        family="Ionicon"
                  ...
                  <Button style={{...styles.socialButtons, marginRight: 30, backgroundColor: argonTheme.COLORS.GMAIL }} onPress={() => navigation.navigate("Home")}>
                    <Block row >
                      <Icon
                        name="logo-google"
                        family="Ionicon"
